...
import sys
sys.path.append("/home/zitong/Downloads/models/research/slim")
sys.path.append("/home/zitong/Downloads/models/research/object_detection")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-la', '--label', default='orange', type=str, help='Label name to detect')
